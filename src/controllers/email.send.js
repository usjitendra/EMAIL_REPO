...
const remoteEmail =
  [
    ...
    "hr@codetokloud.com",
    "aparajita.m@mindbrain.co.in",
    "codeorbite@gmail.com",
    "sushree@mindbrain.co.in",
    "priyadeydas18@gmail.com",
    "itishreem2004@gmail.com",
    "sumanshree.acharya@mindbrain.co.in",
    "visnuc2004@gmail.com",
    "vikassingh.vs242@gmail.com",
    "hr@leastactioncompany.com",
    "nexicotech@gmail.com",
    "application@primateconsulting.net",
    "hexagonsservices@gmail.com",
    "jobs@archelostech.com",
    "shauntel.w@sthrees.com"
  ]
...
export const send_sunil = async () => {
  // await send_sunil_email(emailsss)
}